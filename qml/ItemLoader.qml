...
Loader {
    ...
    property int presentationStatus: effectiveStatus
    ...
    on__UrlChanged: {
        setSource(__url, {
            ...
            presentationIcon: Qt.binding(() => presentationIcon),
            presentationText: Qt.binding(() => presentationText),
            inlinePresentation: Qt.binding(() => inlinePresentation),
        });
    }
}
